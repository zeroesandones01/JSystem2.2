...
public class modelSCDM_OutAccounts extends DefaultTableModel {

	private static final long serialVersionUID = 1L;

	public modelSCDM_OutAccounts() {
		initThis();
	}

	public modelSCDM_OutAccounts(int rowCount, int columnCount) {
		super(rowCount, columnCount);
	}

	public modelSCDM_OutAccounts(Vector columnNames, int rowCount) {
		super(columnNames, rowCount);
	}

	public modelSCDM_OutAccounts(Object[] columnNames, int rowCount) {
		super(columnNames, rowCount);
	}

	public modelSCDM_OutAccounts(Vector data, Vector columnNames) {
		super(data, columnNames);
	}

	public modelSCDM_OutAccounts(Object[][] data, Object[] columnNames) {
		super(data, columnNames);
	}
