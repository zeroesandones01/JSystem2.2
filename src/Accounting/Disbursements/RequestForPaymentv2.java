...
import tablemodel.modelDRF_Particularsv2;
...
public class RequestForPaymentv2 extends _JInternalFrame implements _GUI, ActionListener, MouseListener, KeyListener {
	...
	public static modelDRF_Particularsv2 modelDRF_part;
	...
	public RequestForPaymentv2() {
		super(title, true, true, true, true);
		initGUI();
	}

	public RequestForPaymentv2(String title) {
		super(title);
		// TODO Auto-generated constructor stub
	}

	public RequestForPaymentv2(String title, boolean resizable, boolean closable, boolean maximizable,
			boolean iconifiable) {
		...
		}
		{
...

			{
...

				{
					...
					{
						modelDRF_part = new modelDRF_Particularsv2();
	...
	public static Object[] getDRFdetails(String req_no) {
		...
		String strSQL = "select \r\n" + "a.rplf_no,\r\n" + "a.rplf_date,\r\n" + "a.date_needed,\r\n"
				...
				//Added by Erick DCRF 2683 
				  ...
				  + "						from (\n" +
				  "							select case when b.or_no_reference is not null then b.or_no_reference else  c.rpt_or_no end as remarks, a.rplf_no \n"
				  + "							from rf_request_header a\n" +
				  ...
				  "							and a.co_id = '"
				  +co_id+"' group by a.rplf_no,or_no_reference, rpt_or_no \n" +
