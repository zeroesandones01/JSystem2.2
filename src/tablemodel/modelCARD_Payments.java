...
public class modelCARD_Payments extends DefaultTableModel {

	private static final long serialVersionUID = 1L;

	public modelCARD_Payments() {
		initThis();
	}

	public modelCARD_Payments(int rowCount, int columnCount) {
		super(rowCount, columnCount);
	}

	public modelCARD_Payments(Vector columnNames, int rowCount) {
		super(columnNames, rowCount);
	}

	public modelCARD_Payments(Object[] columnNames, int rowCount) {
		super(columnNames, rowCount);
	}

	public modelCARD_Payments(Vector data, Vector columnNames) {
		super(data, columnNames);
	}

	public modelCARD_Payments(Object[][] data, Object[] columnNames) {
		super(data, columnNames);
	}
	...
	private void initThis() {
		setColumnIdentifiers(new String[] {
				...
				"Rec ID", // 23
				"Client Seq. No.", //24
				"Refund Date", //25 //Added by John Lester Fatallo 2016-04-01
				"Applied Amt", //26 //Added by John Lester Fatallo 2016-04-01
				"Request No" //27 //Added by Lester 2016-11-18 for reference in displaying of Credit Payment History in CARD 
