...
public class PagibigReports extends _JInternalFrame implements ActionListener, _GUI {

	private static final long serialVersionUID = 4824765883993218355L;
	static String title = "REM Conversion Reports";
	...
	public PagibigReports() {
		super(title, false, true, true, true);
		initGUI(); 
	}

	public PagibigReports(String title) {
		super(title);
		initGUI();
	}

	public PagibigReports(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	private void Generate(String strReport) {
		...
		if (strReport.equals("2 - REM Conversion Movement Report")) { 
			...
			/*
			if (strYearFrom<=2017 && strYearTo<=2017) {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_movement_report_2017.jasper", strReport + " 2017 Backwards", "", mapParameters);
			} else if (strYearFrom<=2017 && strYearTo>=2018) {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_movement_report_2017.jasper", strReport + " 2017 Backwards", "", mapParameters);
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_movement_report_2018_above.jasper", strReport + " 2018 Onwards", "", mapParameters);
			} else {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_movement_report_2018_above.jasper", strReport + " 2018 Onwards", "", mapParameters);
			}
			*/
			
			FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_movement_report.jasper", strReport, "", mapParameters);
			
		} else if (strReport.equals("1 - REM Conversion Status Report")) {
			mapParameters.put("co_id", txtCoID.getText());
			mapParameters.put("co_name", txtCompany.getText());
			mapParameters.put("dateFrom", dteDateFrom.getText());
			mapParameters.put("dateTo", dteDateTo.getText());
			...
			/*
			if (strYearFrom<=2017 && strYearTo<=2017) {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_status_report_2017.jasper", strReport + " 2017 Backwards", "", mapParameters);
			} else if (strYearFrom<=2017 && strYearTo>=2018) {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_status_report_2017.jasper", strReport + " 2017 Backwards", "", mapParameters);
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_status_report_2018_above.jasper", strReport + " 2018 Onwards", "", mapParameters);
			} else {
				FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_status_report_2018_above.jasper", strReport + " 2018 Onwards", "", mapParameters);
			}
			*/
			
			FncReport.generateReport("/Reports/rpt_hdmf_rem_conversion_status_report_2018_above.jasper", strReport, "", mapParameters);
			
		} else if (strReport.equals("3 - Loan Released Not Endorsed for REM")) {
			...
			mapParameters.put("04_ProID", strProject);
			mapParameters.put("05_Project", txtProject.getText());
			mapParameters.put("06_User", UserInfo.EmployeeCode);
			mapParameters.put("07_Logo", this.getClass().getClassLoader().getResourceAsStream("Images/"+ company_logo));
			mapParameters.put("08_Phase", strPhase);
			mapParameters.put("09_From", dteDateFrom.getDate());
			mapParameters.put("10_To", dteDateTo.getDate());
			FncReport.generateReport("/Reports/rpt_hdmf_loanReleasedNotEndorsedForREM.jasper", strReport, "", mapParameters);
		} else if (strReport.equals("4 - Cancelled Accounts")) {
			mapParameters.put("01_Company", txtCompany.getText());
			mapParameters.put("02_AsOfDate", strDate);
			mapParameters.put("03_CoID", txtCoID.getText());
			mapParameters.put("04_ProID", strProject);
			...
			mapParameters.put("09_From", dteDateFrom.getDate());
			mapParameters.put("10_To", dteDateTo.getDate());
			FncReport.generateReport("/Reports/rpt_rem_cancelled_accts_g_to_g.jasper", strReport, "", mapParameters);
		} else if (strReport.equals("5 - Full Settled Accounts")) {
			mapParameters.put("01_Company", txtCompany.getText());
			mapParameters.put("02_AsOfDate", strDate);
			mapParameters.put("03_CoID", txtCoID.getText());
			mapParameters.put("04_ProID", strProject);
			...
			mapParameters.put("09_From", dteDateFrom.getDate());
			mapParameters.put("10_To", dteDateTo.getDate());
			FncReport.generateReport("/Reports/rpt_hdmf_rem_full_settled.jasper", strReport, "", mapParameters);
		} else if (strReport.equals("6 - Officially REM Accounts")) {
			mapParameters.put("01_Company", txtCompany.getText());
			mapParameters.put("02_AsOfDate", strDate);
			mapParameters.put("03_CoID", txtCoID.getText());
			mapParameters.put("04_ProID", strProject);
			...
			mapParameters.put("09_From", dteDateFrom.getDate());
			mapParameters.put("10_To", dteDateTo.getDate());
			FncReport.generateReport("/Reports/rpt_hdmf_off_rem.jasper", strReport, "", mapParameters);
		} else 
		{
			JOptionPane.showMessageDialog(getContentPane(), "No Reports Yet");
		}
	}
