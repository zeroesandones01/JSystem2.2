...
public class PreDocsEvaluationReport extends _JInternalFrame implements _GUI, ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7871902524704291271L;
	/**
	 * 
	 */
	static String title = "Pre-Docs Evaluation Report";
	...
	public PreDocsEvaluationReport() {
		super(title, false, true, false, true);
		initGUI();
	}

	public PreDocsEvaluationReport(String title) {
		super(title, false, true, false, true);
		initGUI();
	}

	public PreDocsEvaluationReport(String title, boolean resizable, boolean closable,
			...
			pnlMain.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
			{
				...
				pnlCenter.setPreferredSize(new Dimension(0, 20));
				{
					...
					}
					{
						...
						pnlCenterLabel.add(lblSalesGroup);
					}
				}
				{
					...
					}
					{
						...
						{
							lookupSalesDivision = new _JLookup(null, "Select Sales Group", 0);
							pnlSalesGroup.add(lookupSalesDivision, BorderLayout.WEST);
							lookupSalesDivision.setPreferredSize(new Dimension(50, 0));
						...
						}
						{
							...
							pnlSalesGroup.add(txtSalesGroup);
						}
					}
				}
			}
	...
	private void filterPreview(){
		if(UserInfo.Division.equals("06") || UserInfo.Division.equals("08") || UserInfo.Division.equals("09") || UserInfo.Division.equals("07")){
			...
			lookupSalesDivision.setValue(UserInfo.Division);
			txtSalesGroup.setText(UserInfo.Division_Alias);
		}else{
			lookupSalesDivision.setEditable(true);
			lookupSalesDivision.setValue(null);
	...
	public void actionPerformed(ActionEvent e) { 
		...
		if(actionCommand.equals("Preview")){
				...
				mapParameters.put("sales_division", lookupSalesDivision.getValue());

				FncReport.generateReport("/Reports/rptDocsEval_Report.jasper","Docs Evaluation Report" , mapParameters);
		}
	}
}
