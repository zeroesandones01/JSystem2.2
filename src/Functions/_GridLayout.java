...
public class _GridLayout extends GridLayout {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6096328517267385526L;

	public _GridLayout() {
		this(1, 0, 0, 0);
	}

	public _GridLayout(int rows, int cols) {
		this(rows, cols, 0, 0);
	}

	public _GridLayout(int rows, int cols, int hgap, int vgap) {
