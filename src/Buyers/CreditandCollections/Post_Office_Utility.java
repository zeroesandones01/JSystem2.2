...
public class Post_Office_Utility extends _JInternalFrame implements _GUI,MouseListener,ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static String title = "Post Office Utility";
	public static Dimension frameSize = new Dimension(650, 505);
	...
	public Post_Office_Utility() {
		super(title, true, true, true, true);
		initGUI();
	}

	public Post_Office_Utility(String title) {
		super(title);
		initGUI();
	}

	public Post_Office_Utility(String title, boolean resizable,
				...
				pnlMain.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
				{
...

					{
...

						{
							...
							pnlBatch_West.add(pnlBatch,BorderLayout.WEST);
							{
								...
								lblReceiveby = new JLabel("Received By :");
					...
					}
					{
						...
						pnlNorth.add(pnlBatchAction_Center,BorderLayout.CENTER);
						{
							...
							pnlBatchAction.setPreferredSize(new Dimension(250, 100));
							{
								lookupBatchno = new _JLookup("Batch No.", "Batch No.", 0);
								pnlBatchAction.add(lookupBatchno);
								lookupBatchno.setLookupSQL("SELECT DISTINCT batch_no AS \"Batch No.\" FROM rf_notices_sent WHERE sent_to = 'POST OFFICE'");
...
//								pnlBatchAction.add(txtLocation);
								...
								pnlBatchAction.add(txtLocation);
								txtLocation.setText("MANDALUYONG POST OFFICE");

							}
							{
//								txtReceiveby = new JXTextField("Received by");
//								pnlBatchAction.add(txtReceiveby);
								
								txtReceiveby = new JXTextField();
								pnlBatchAction.add(txtReceiveby);
...

					{
						...
						pnlListBatch.setBorder(components.JTBorderFactory.createTitleBorder("List of Batch"));
						{
							...
							});
							{
								...
								modelListBatchModel.setEditable(true);
