...
public class ReturnCheckMBTC extends _JInternalFrame implements _GUI, ActionListener, AncestorListener {
	...
	public ReturnCheckMBTC() {
		super(title, false, true, false, true);
		initGUI();
	}

	public ReturnCheckMBTC(String title) {
		super(title);
		initGUI();
	}

	public ReturnCheckMBTC(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
