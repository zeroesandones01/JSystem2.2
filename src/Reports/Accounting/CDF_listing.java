...
public class CDF_listing extends _JInternalFrame implements ActionListener, AncestorListener, _GUI {
	...
	static String title = "CDF Listing";
	...
	public CDF_listing(String title) {
		super(title);
		initGUI();
	}

	public CDF_listing(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	public void initGUI() {
		...
		this.setPreferredSize(new java.awt.Dimension(513, 322));
		...
		this.addAncestorListener(this);
		{
...

			{
				...
				pnlNorth.setPreferredSize(new java.awt.Dimension(499, 118));
...

			{
				...
				pnlCPFdate.setPreferredSize(new java.awt.Dimension(499, 26));		
			...
			}
			{
				...
				pnlCPFreport_type.setPreferredSize(new java.awt.Dimension(499, 104));		

				{
					pnlCPFreport_type_a = new JPanel(new GridLayout(2, 1, 5, 5));
					...
					{
						lblStatus = new JLabel("CDF Status", JLabel.TRAILING);
						pnlCPFreport_type_a.add(lblStatus, BorderLayout.CENTER);
				...
				{
					pnlCPFreport_type_b = new JPanel(new GridLayout(2, 1, 5, 5));
					pnlCPFreport_type.add(pnlCPFreport_type_b, BorderLayout.EAST);
					pnlCPFreport_type_b.setPreferredSize(new java.awt.Dimension(404, 72));
					{
						String status[] = {
								"CDF Listing"
								};					
					...
					}
					{
						...
						cmbStatus = new JComboBox(status2);
						pnlCPFreport_type_b.add(cmbStatus);
						...
						cmbStatus.addItemListener(new ItemListener() {
							public void itemStateChanged(ItemEvent evt) 
							{		
								status_no = cmbReportName.getSelectedIndex();
							}
						});
					}
				}
		...
		this.setBounds(0, 0, 513, 322);  //174
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Preview")&&cmbReportName.getSelectedIndex()==0){ previewCDF_listing();}
	...
	//preview
	private void previewCDF_listing(){

		String criteria = "CDF Listing";		
		...
		mapParameters.put("phase_name", phase_name);
		mapParameters.put("status_no", cmbStatus.getSelectedIndex());
