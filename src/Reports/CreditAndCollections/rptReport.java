...
public class rptReport extends _JInternalFrame implements _GUI, ActionListener, AncestorListener {
	...
	public rptReport(String title) {
		super(title);
		initGUI();
	}

	public rptReport(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
...
//				}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(action.equals("Preview")){
			...
			FncReport.generateReport("/Reports/rptReport.jasper", title, txtProject.getText(), txtPhase.getText(), mapParameters);
