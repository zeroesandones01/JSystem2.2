...
public class BankFinance_ClientStatusReport extends _JInternalFrame implements _GUI, ActionListener {
	static String title = "Bank Financing Client Status Reports";
	...
	public BankFinance_ClientStatusReport() {
		super(title, false, true, false, true);
		initGUI();
	}

	public BankFinance_ClientStatusReport(String title) {
		super(title, false, true, false, true);
		initGUI();
	}

	public BankFinance_ClientStatusReport(String title, boolean resizable, boolean closable,
	...
	public void actionPerformed(ActionEvent e) { 
		...
		if(actionCommand.equals("Preview")){
			...
			FncReport.generateReport("/Reports/rptBankFinancing_ClientStatus.jasper","Bank Finance Client Status" , mapParameters);
		}
	}
}
