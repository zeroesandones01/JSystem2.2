...
public class ReturnCheckMBTCPcost extends _JInternalFrame implements _GUI, ActionListener, AncestorListener {
	...
	public ReturnCheckMBTCPcost() {
		super(title, false, true, false, true);
		initGUI();
	}

	public ReturnCheckMBTCPcost(String title) {
		super(title);
		initGUI();
	}

	public ReturnCheckMBTCPcost(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
