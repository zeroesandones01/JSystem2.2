...
public class WaterMeterInstallation_Report extends _JInternalFrame implements _GUI, ActionListener {
	...
	public WaterMeterInstallation_Report() {
		super(title, false, true, false, true);
		initGUI();
	}

	public WaterMeterInstallation_Report(String title) {
		super(title, false, true, false, true);
		initGUI();
	}

	public WaterMeterInstallation_Report(String title, boolean resizable, boolean closable,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(actionCommand.equals("Preview")) {
			...
			FncReport.generateReport("/Reports/rptWaterMeterInstallationReport.jasper","Water Meter Installation Report" , mapParameters);
		}
