		...
		if (data != null) {
			...
			if (print_type.equals("MINOR CONTRACT")) {
				...
				if (lookupNTPType.getValue().equals("10") || lookupNTPType.getValue().equals("03")) {
					if(lookupNTPNo.getValue().equals("002364") || lookupNTPNo.getValue().equals("002367") || lookupNTPNo.getValue().equals("002368") || lookupNTPNo.getValue().equals("002369") || lookupNTPNo.getValue().equals("002370") || lookupNTPNo.getValue().equals("002373")) {
