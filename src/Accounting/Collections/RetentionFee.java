...
public class RetentionFee extends _JInternalFrame implements _GUI, ActionListener {

	private static final long serialVersionUID = 2321370387432898517L;
	private static String title = "Retention Fee"; 
	...
	private static _JXFormattedTextField txtVarPayUndertaking;
	private static _JXFormattedTextField txtPayRet1;
	private static _JXFormattedTextField txtPayRet21;
	private static _JXFormattedTextField txtPayRet22;
	
	private static _JXFormattedTextField txtVarBalUndertaking;
	private static _JXFormattedTextField txtBalRet1;
	...
	public RetentionFee(String title) {
		super(title, true, true, false, true);
		initGUI();
	}

	public RetentionFee(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
													...
													txtClientID.addLookupListener(new LookupListener() {
														public void lookupPerformed(LookupEvent event) {
															...
															if (data!=null) {
																...
																DisplayRetEntries(); 
																ComboboxAction();
																FncSystem.out("Display SQL For Client", txtClientID.getLookupSQL());
															}
														}
													});
												}
...
//														});
										...
										{
											{
												...
												txtPctg.getDocument().addDocumentListener(new DocumentListener() {
													...
													private void ComputeRetention() {
														...
														txtAmount.setValue(dbLoanAmt.multiply(dbPercentage));  
													}
												});
				...
				{
					{
						...
						panCenterPage.setPreferredSize(new Dimension(0, 150));
						{
							...
							panDiv.setBorder(JTBorderFactory.createTitleBorder("", FncLookAndFeel.systemFont_Bold.deriveFont(10f)));
							{
								{
									...
									panDiv.add(panDiv0);
									{
										...
										{
											lblUndertaking = new JLabel("---"); 
											panDiv0.add(lblUndertaking);
											lblUndertaking.setHorizontalAlignment(JTextField.LEFT);
											lblUndertaking.setFont(font10b);
										}
										{
											JLabel lblRet1 = new JLabel("RETFEE1"); 
											panDiv0.add(lblRet1);
											lblRet1.setHorizontalAlignment(JTextField.LEFT);
											lblRet1.setFont(font10b);
										}
										{
								...
								}
								{
									...
									panDiv.add(panDiv1);
									{
										...
										{
											txtVarPayUndertaking = new _JXFormattedTextField("0.00");
											panDiv1.add(txtVarPayUndertaking, BorderLayout.CENTER);
											txtVarPayUndertaking.setHorizontalAlignment(JTextField.TRAILING);
											txtVarPayUndertaking.setFormatterFactory(_JXFormattedTextField.DECIMAL);
											txtVarPayUndertaking.setEditable(false);
										}
										{
											txtPayRet1 = new _JXFormattedTextField("0.00");
											panDiv1.add(txtPayRet1, BorderLayout.CENTER);
											txtPayRet1.setHorizontalAlignment(JTextField.TRAILING);
											txtPayRet1.setFormatterFactory(_JXFormattedTextField.DECIMAL);
											txtPayRet1.setEditable(false);
										}
										{
								...
								}
								{
									...
									panDiv.add(panDiv2);
									{
										...
										{
											txtVarBalUndertaking = new _JXFormattedTextField("0.00");
											panDiv2.add(txtVarBalUndertaking, BorderLayout.CENTER);
											txtVarBalUndertaking.setHorizontalAlignment(JTextField.TRAILING);
											txtVarBalUndertaking.setFormatterFactory(_JXFormattedTextField.DECIMAL);
											txtVarBalUndertaking.setEditable(false);
										}
										{
											txtBalRet1 = new _JXFormattedTextField("0.00");
											panDiv2.add(txtBalRet1, BorderLayout.CENTER);
											txtBalRet1.setHorizontalAlignment(JTextField.TRAILING);
											txtBalRet1.setFormatterFactory(_JXFormattedTextField.DECIMAL);
											txtBalRet1.setEditable(false);
										}
										{
	...
	private void GenFees() {
		lblUndertaking.setText(getParticular());
		
		pgSelect db = new pgSelect(); 
		db.select("select * from view_hdmf_retfees_dues('"+txtClientID.getValue().toString()+"', '"+txtProjectID.getText()+"', '"+txtUnitID.getText()+"', '"+txtSeqNo.getText()+"')"); 
		
		if (db.isNotNull()) {
			txtPayRet1.setValue(db.getResult()[0][0]);
			txtPayRet21.setValue(db.getResult()[0][1]);
			txtPayRet22.setValue(db.getResult()[0][2]);
			
			txtBalRet1.setValue(db.getResult()[0][3]);
			txtBalRet21.setValue(db.getResult()[0][4]);
			txtBalRet22.setValue(db.getResult()[0][5]);
			
			txtVarPayUndertaking.setValue(db.getResult()[0][8]);
			txtVarBalUndertaking.setValue(db.getResult()[0][9]);
