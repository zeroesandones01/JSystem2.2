...
public class RTSNoticesReport extends _JInternalFrame implements _GUI , ActionListener, AncestorListener{
	
	static String title = "Return to Sender Notices Report";
	...
	public RTSNoticesReport() {
		super(title, false, true, false, true);
		initGUI();
	}

	public RTSNoticesReport(String title) {
		super(title);
		initGUI();
	}

	public RTSNoticesReport(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
				...
				pnlSouth.setPreferredSize(new Dimension(388, 30));
				{
					...
					btnPreview.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							System.out.println("Select * from view_rts_notices('"+lookupCompany.getValue()+"','"+lookupProject.getValue()+"','"+lookupPhase.getValue()+"','"+sdf.format(dateFrom.getDate())+"','"+sdf.format(dateTo.getDate())+"');");
							...
							mapParameters.put("date_from", sdf.format(dateFrom.getDate()));
							mapParameters.put("date_to",sdf.format(dateTo.getDate()));
							//mapParameters.put("date_from", sdf.format(dateFrom.getDate()));
							...
							FncReport.generateReport("/Reports/rptRTSNotices.jasper", "RTS Notices Report", txtProject.getText(), txtPhase.getText(), mapParameters);
	//						FncReport.generateReport("/Reports/rptRTSNoticesTransmittal.jasper", "RTS Notices Transmittal", txtProject.getText(), txtPhase.getText(), mapParameters);

//							FncReport.generateReport("/Reports/rptRTSNotices.jasper", "RTS Notices", txtProject.getText(), txtPhase.getText(), mapParameters);
//							FncReport.generateReport("/Reports/rptRTSNoticesTransmittal.jasper", "RTS Notices Transmittal", txtProject.getText(), txtPhase.getText(), mapParameters);
