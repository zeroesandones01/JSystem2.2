...
/*
 * $Id: _JXDialog.java,v 1.1 2019/04/10 00:30:13 jfatallo Exp $
 *
 ...
 */
public class _JXDialog extends JDialog {
	 ...
	 */
	public _JXDialog(JComponent content) {
		super();
		setContent(content);
	}
	 ...
	 * @param content the component to show and to auto-configure from.
	 */
	public _JXDialog(Frame frame, JComponent content) {
		super(frame);
		setContent(content);
	}
	 ...
	 * @param content the component to show and to auto-configure from.
	 */
	public _JXDialog(Dialog dialog, JComponent content) {
		super(dialog);
		setContent(content);
	}
	...
	private void build() {
		...
		JXPanel panel = new JXPanel(new BorderLayout(5, 5));
	...
	protected JComponent createButtonPanel() {
		...
		panel.setPreferredSize(new java.awt.Dimension(102, 0));
