/*
 * $Id: _JXImagePanel.java,v 1.1 2019/04/10 00:30:10 jfatallo Exp $
 *
 ...
 * </p>
 * <p>
 * other than the image loading this component can be replicated by a
...
@Deprecated
class _JXImagePanel extends JXPanel {
    /**
	 * 
	 */
    ...
    private static final Logger LOG = Logger.getLogger(_JXImagePanel.class.getName());
    ...
    public _JXImagePanel() {
    }

    //remove this constructor; no where else can a URL be used in this class
    public _JXImagePanel(URL imageUrl) {
        try {
    ...
    public Image getImage() {
        ...
        //perhaps we should have a default image loader?
            ...
            service.execute(new FutureTask<Image>(imageLoader) {
                ...
                protected void done() {
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            try {
                                _JXImagePanel.this.setImage(get());
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent evt) {
            ...
            int retVal = chooser.showOpenDialog(_JXImagePanel.this);
