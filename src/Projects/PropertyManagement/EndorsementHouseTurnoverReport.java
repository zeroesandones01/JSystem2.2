...
public class EndorsementHouseTurnoverReport extends _JInternalFrame implements _GUI, ActionListener {
	
	private static final long serialVersionUID = -393468008940008144L;
	static String title = "Endorsement House Turnover Reports (Cash)";
	...
	public EndorsementHouseTurnoverReport() {
		super(title, false, true, false, true);
		initGUI();
	}

	public EndorsementHouseTurnoverReport(String title) {
		super(title, false, true, false, true);
		initGUI();
	}

	public EndorsementHouseTurnoverReport(String title, boolean resizable, boolean closable,
	...
	public void actionPerformed(ActionEvent e) { 
		...
		if(actionCommand.equals("Preview")){
			...
			FncReport.generateReport("/Reports/rptEndorsementHouseTurnover_Report.jasper","Endorsement of House Turnover" , mapParameters);
		}
	}
}
