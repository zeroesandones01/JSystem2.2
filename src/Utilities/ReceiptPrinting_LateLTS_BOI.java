...
public class ReceiptPrinting_LateLTS_BOI extends _JInternalFrame implements _GUI, ActionListener {
	...
	static String title = "Receipt Printing (OR Issued for Late LTS/BOI)";
	...
	public ReceiptPrinting_LateLTS_BOI() {
		super(title, true, true, true, true);
		initGUI();
	}

	public ReceiptPrinting_LateLTS_BOI(String title) {
		super(title);
		initGUI();
	}

	public ReceiptPrinting_LateLTS_BOI(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	private void displayReceipts(modelReceiptPrinting_GoodCheck model, JList rowHeader) {
		...
		String SQL = "select * from view_lateor_receipt_printing_cash";
