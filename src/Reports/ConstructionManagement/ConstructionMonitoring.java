...
public class ConstructionMonitoring extends _JInternalFrame implements ActionListener, AncestorListener, _GUI {
	...
	static String title = "Construction Monitoring";
	...
	public ConstructionMonitoring(String title) {
		super(title);
		initGUI();
	}

	public ConstructionMonitoring(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(actionCommand.equals("Preview")){
			...
			String reportTitle = String.format("%s (%s)", title.replace(" Report", ""), cmbCriteria.getSelectedItem());
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportAllUnits.jasper", cmbCriteria.getSelectedItem().toString(), mapParameters);
		/*	}

			if(criteria.equals("w/ NTC but not yet awarded")){
				Map<String, Object> mapParameters = new HashMap<String, Object>();
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportWithIssuedNTC.jasper", reportTitle, txtProject.getText(), mapParameters);
			}
			if(criteria.equals("w/ NTC and awarded")){
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportwithNTP.jasper", reportTitle, txtProject.getText(), mapParameters);
			}
			if(criteria.equals("completed but not yet TO to CMD")){
				Map<String, Object> mapParameters = new HashMap<String, Object>();
				mapParameters.put("company", "CENQHOMES DEVELOPMENT CORPORATION");
				mapParameters.put("proj_id", lookupProject.getText());
				mapParameters.put("phase",  lookupPhase.getText());
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportCompleted.jasper", reportTitle, txtProject.getText(), mapParameters);
			}
			if(criteria.equals("CMD Accepted but not yet TO to PMD")){
				Map<String, Object> mapParameters = new HashMap<String, Object>();
				mapParameters.put("company", "CENQHOMES DEVELOPMENT CORPORATION");
				mapParameters.put("proj_id", lookupProject.getText());
				mapParameters.put("phase", lookupPhase.getText());
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportTOtoCMD.jasper", reportTitle, txtProject.getText(), mapParameters);
			}
			if(criteria.equals("PMD Accepted but not yet TO to Client")){
				Map<String, Object> mapParameters = new HashMap<String, Object>();
				mapParameters.put("company", "CENQHOMES DEVELOPMENT CORPORATION");
				mapParameters.put("proj_id", lookupProject.getText());
				mapParameters.put("phase",  lookupPhase.getText());
				...
				FncReport.generateReport("/Reports/rptConstructionMonitoringReportTOtoPMD.jasper", reportTitle, txtProject.getText(), mapParameters);*/
...
//				"				and a.phase != ''\n" + 
	...
	private String[] getCriteria() {
		return new String[] {
				...
				//"Moved-in w/o MERALCO",
				//"Moved-in w/ MERALCO",
				//"all units except for completed",
				//"all delayed units only"
		};
	}
}