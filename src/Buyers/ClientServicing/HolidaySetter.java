...
public class HolidaySetter extends _JInternalFrame {
	...
	static String title = "Holiday Setter";
	...
	public HolidaySetter(){
		super(title,true,true,false,false);
		initGui();
	}
	public HolidaySetter(String title){
		super(title);
		initGui();
	}
	public HolidaySetter(String title,boolean resizable,boolean closable,boolean maximizable,boolean iconifiable){
