...
public class ContractorsRetentionsPayables extends _JInternalFrame implements ActionListener, AncestorListener, _GUI {
	...
	static String title = "Contractors Retentions Payable";
	//static Dimension frameSize = new Dimension(500, 400);
	...
	public ContractorsRetentionsPayables() {
		super(title, true, true, true, true);
		initGUI();
	}

	public ContractorsRetentionsPayables(String title) {
		super(title);
		initGUI();
	}

	public ContractorsRetentionsPayables(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	public void initGUI() {
		...
		//this.setPreferredSize(new java.awt.Dimension(624, 170));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Preview")){		
			...
			FncReport.generateReport("/Reports/rptContractorRetentionsPayable.jasper", reportTitle, "", mapParameters);
		}
	...
	private JPanel getbillingdate() {
...

		{
			...
			lblDateFrom = new JLabel("As of:  ", JLabel.LEADING);
		...
		}
		{
			...
			lblDateTo = new JLabel("", JLabel.CENTER);
