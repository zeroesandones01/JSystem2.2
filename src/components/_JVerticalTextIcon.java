 ...
 */
public class _JVerticalTextIcon implements Icon, PropertyChangeListener {
	String fLabel;
	 ...
	 * @see #verifyRotation
	 */
	public _JVerticalTextIcon(Component component, String label) {
	 ...
	 * @see #verifyRotation
	 */
 	public _JVerticalTextIcon(Component component, String label, int rotateHint) {
