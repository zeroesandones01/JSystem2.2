 ...
 * @author jaricruz
 */
public class FSAcctsMonitoring extends _JInternalFrame implements _GUI, ActionListener, AncestorListener {

	private static final long serialVersionUID = -8278094019499166949L;

	static String title = "Full Settled Accts Monitoring";
	 ...
	 * @param title
	 */
	public FSAcctsMonitoring(String title) {
		super(title);
		initGUI();
	}
	 ...
	 * @param iconifiable
	 */
	public FSAcctsMonitoring(String title, boolean resizable, boolean closable, boolean maximizable,
			boolean iconifiable) {
		super(title, false, true, false, true);
		initGUI();
	}
