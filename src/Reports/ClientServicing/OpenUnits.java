...
public class OpenUnits extends _JInternalFrame implements _GUI, ActionListener, AncestorListener {
	...
	Dimension frameSize = new Dimension(510, 250);// 510, 250
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(action.equals("Preview")){
			...
			mapOpenUnits.put("prepared_by", UserInfo.FullName);
			mapOpenUnits.put("prepared_by_alias", UserInfo.Alias);
			mapOpenUnits.put("user_id", UserInfo.EmployeeCode);

			if(chkOpenHouse.isSelected()){
				FncReport.generateReport("/Reports/rptOpenUnits_OpenHouse.jasper", title, txtProject.getText(), txtPhase.getText(), mapOpenUnits);
			}else{
				FncReport.generateReport("/Reports/rptOpenUnits.jasper", title, txtProject.getText(), txtPhase.getText(), mapOpenUnits);
			}
		}
	}
