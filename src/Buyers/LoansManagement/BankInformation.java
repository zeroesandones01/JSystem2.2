...
public class BankInformation extends _JInternalFrame implements _GUI, ActionListener, MouseListener{
	...
	private JMenuItem menuItemBankSchedule;
	private JMenuItem menuItemBuyback;
	...
	private JButton btn_preview_buyback;
	...
	public void initGUI() {
		...
		{
			menuItemBankSchedule = new JMenuItem("Preview Bank Schedule");
			menuRightClick.add(menuItemBankSchedule);
			menuItemBankSchedule.addActionListener(new ActionListener() {
				...
				pnlClientDetails.setName("Client");
				{
					...
					}
					{
						...
						pnlCDNorth.add(pnlCDNComponent, BorderLayout.CENTER);
						{
							...
							lookupCDClient.setFilterName(true);
				...
				}
				{
					...
					}
					{
						...
						pnlBuyback_main.setName("Buyback");
						{
							...
							{
								JPanel pnlBuyback_north = new JPanel(new BorderLayout(5, 5));
								JPanel pnlBuyback_north_west = new JPanel(new GridLayout(1, 4, 5, 5));
								pnlBuyback_north_west.setPreferredSize(new Dimension(800, 20));
								pnlBuyback_north.setBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2));
								pnlBuyback_north.add(pnlBuyback_north_west);
								
								pnlBuyback.add(pnlBuyback_north, BORDER_LAYOUT.WEST);	
								{
									{
										JPanel pnlBuyback_date = new JPanel(new BorderLayout(5, 5));
										pnlBuyback_north_west.add(pnlBuyback_date);
											...
											lookupBuyback.addLookupListener(new LookupListener() {
												...
												public void lookupPerformed(LookupEvent event) {
													...
													if(data != null){
														...
														btn_preview_buyback.setEnabled(true);

														{
															menuItemBuyback = new JMenuItem("Preview Buyback");
															menuRightClick.add(menuItemBuyback);
															menuItemBuyback.addActionListener(new ActionListener() {
									...
									
									{
										...
										pnlBuyback_north_west.add(pnlBuyback_tran_type);
									...
									
									{
										...
										pnlBuyback_north_west.add(pnlBuyback_rplf_no);
									...
									
									{
										...
										pnlBuyback_north_west.add(pnlBuyback_remarks);
								...
								{
									{
										btn_preview_buyback = new JButton("Preview");
										btn_preview_buyback.setPreferredSize(new Dimension(80, 20));
										btn_preview_buyback.setEnabled(false);
										pnlBuyback_north.add(btn_preview_buyback, BORDER_LAYOUT.EAST);
										btn_preview_buyback.addActionListener(new ActionListener() {
											
											@Override
											public void actionPerformed(ActionEvent e) {
												// TODO Auto-generated method stub
												System.out.println("Preview for buyback");
												generateBuybackReport();
											}
										});
									}
	...
	private void clearBuybackInfo(){
		modelBuyback.clear();
		lookupBuyback.setValue("");
	...
	private void displayClientInfo(String entity_id, String proj_id, String pbl_id, Integer seq_no){
		...
		String sql = "SELECT get_client_name(a.entity_id) as client_name,\n"
				...
				+ "(select gross_sprice from rf_client_price_history where entity_id = a.entity_id and proj_id = a.projcode and pbl_id = a.pbl_id and seq_no = a.seq_no and status_id = 'A'),\n"
				+ "(select discount from rf_client_price_history where entity_id = a.entity_id and proj_id = a.projcode and pbl_id = a.pbl_id and seq_no = a.seq_no and status_id = 'A'),\n"
				+ "(select vat from rf_client_price_history where entity_id = a.entity_id and proj_id = a.projcode and pbl_id = a.pbl_id and seq_no = a.seq_no and status_id = 'A'),\n"
				+ "(select net_sprice from rf_client_price_history where entity_id = a.entity_id and proj_id = a.projcode and pbl_id = a.pbl_id and seq_no = a.seq_no and status_id = 'A'),\n"
	...
	private void displayBankLedger(String entity_id, String proj_id, String pbl_id, Integer seq_no){
		...
		String sql = "SELECT\n"
				...
				+ "(SELECT amount from rf_bank_ledger WHERE entity_id = a.entity_id and proj_id = a.proj_id and pbl_id = a.pbl_id and seq_no = a.seq_no and scheddate::date = a.scheddate and part_id = '001' and status_id = 'A')::NUMERIC as interest,\n"
				+ "(SELECT amount from rf_bank_ledger WHERE entity_id = a.entity_id and proj_id = a.proj_id and pbl_id = a.pbl_id and seq_no = a.seq_no and scheddate::date = a.scheddate and part_id = '002' and status_id = 'A')::NUMERIC as principal,\n"
				+ "a.balance::NUMERIC\n"
	...
	//GENERATES THE BANK LEDGER REPORT
	private void generateBankScheduleReport(){
		...
		mapParameters.put("entity_name", txtCDClient.getText());
		mapParameters.put("proj_id", proj_id);
		mapParameters.put("unit_id", pbl_id);
		mapParameters.put("pbl_id", pbl_id);
		mapParameters.put("seq_no", seq_no);
		
		FncReport.generateReport("/Reports/rpt_bankinfo_schedule.jasper", "Bank Schedule", mapParameters);
	}
	
	//GENERATES THE BUYBACK REPORT
	private void generateBuybackReport(){
		...
		String SQL = "select * from view_bankinfo_buyback_report(\n"
				+ "	'"+entity_id+"',\n"
				+ "	'"+proj_id+"',\n"
				+ "	'"+pbl_id+"',\n"
				+ "	"+seq_no+",\n"
				+ "	'"+buyback_date+"')";
		FncSystem.out("view_bankinfo_buyback_report", SQL);
		...
		public void mousePressed(MouseEvent ev) {
			if (ev.isPopupTrigger()) {
				...
				if(component_name.equals("Client")) {
					{
						menuRightClick = new JPopupMenu("Popup");
						menuItemBankLedger = new JMenuItem("Preview Bank Schedule");
						menuRightClick.add(menuItemBankLedger);
						menuItemBankLedger.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								if(menu_item.equals("Preview Bank Schedule")) {
									System.out.println("Do preview bank schedule");
									generateBankScheduleReport();
								}
							}
						});
