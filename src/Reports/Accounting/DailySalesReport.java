...
public class DailySalesReport extends _JInternalFrame implements ActionListener, AncestorListener, _GUI {
	...
	static String title = "Daily Sales Report";
	...
	public DailySalesReport(String title) {
		super(title);
		initGUI();
	}

	public DailySalesReport(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Preview")&& cmbReportName.getSelectedIndex()==0){ previewDailySalesRpt();}
	...
	//preview
	private void previewDailySalesRpt(){

		String criteria = "Daily Sales Report";		
		...
		FncReport.generateReport("/Reports/rptDailySalesReport.jasper", reportTitle, company, mapParameters);		
	}
