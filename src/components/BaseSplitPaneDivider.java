...
public class BaseSplitPaneDivider extends BasicSplitPaneDivider {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6661006402116108875L;
				...
				if (orientation == JSplitPane.HORIZONTAL_SPLIT) {
					...
					if ((verBumps != null) && (height > verBumps.getIconHeight())) {
						...
						if (splitPane.isOneTouchExpandable() && centerOneTouchButtons) {
							...
							//g.setFont(new Font("SansSerif Sans", 6, Font.PLAIN));
							//g.drawString("Sample", 0, y);
	...
	protected JButton createLeftOneTouchButton() {
		JButton b = new JButton() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5558385096740102414L;
	...
	protected JButton createRightOneTouchButton() {
		JButton b = new JButton() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -2940395558471233000L;
